...
<nav id="<?php echo apply_filters(
	'wp_rig_site_navigation_id',
	'site-navigation',
);
/* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */
?>" class="<?php echo apply_filters(
	'wp_rig_site_navigation_classes',
...
?>" aria-label="<?php esc_attr_e('Main menu', 'wp-rig'); ?>">
	<?php
 $menu_toggle_button =
 	'<button class="menu-toggle" aria-label="' .
