...
class Component_Tests extends Unit_Test_Case
{
	...
	public function test_initialize()
	{
		...
		$this->assertNotEquals(
			false,
			has_action('wp_print_footer_scripts', [
				$this->component,
		...
		$this->assertNotEquals(
			false,
			has_filter('nav_menu_link_attributes', [
				$this->component,
				'filter_nav_menu_link_attributes_aria_current',
			]),
		);
		$this->assertNotEquals(
			false,
			has_filter('page_menu_link_attributes', [
				$this->component,
				'filter_nav_menu_link_attributes_aria_current',
			]),
		);
	...
	public function test_filter_nav_menu_link_attributes_aria_current()
	{
		$atts = [];
		$item = $this->mock_post;
		$atts = $this->component->filter_nav_menu_link_attributes_aria_current(
			$atts,
			$item,
		);
