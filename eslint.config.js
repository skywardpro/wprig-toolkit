...
export default [
...

	{
		...
		rules: {
			"prettier/prettier": [
				"error",
				{
					endOfLine: "auto", // Автоматически определяет концы строк
					useTabs: true, // WP Rig использует табы
					tabWidth: 2, // Ширина таба
					printWidth: 80, // Длина строки
					singleQuote: true, // Одинарные кавычки
					semi: true, // Точки с запятой
					trailingComma: "es5", // Запятые в конце объектов
				},
			],
		},
	},
	...
	// Overides rules for gulp folder. Replaces the former gulp/.eslintrc.json.
	{
		...
		rules: {
			...
			"jsdoc/no-undefined-types": ["error", { definedTypes: ["Stream"] }],
			"import/no-extraneous-dependencies": [
				"error",
				{
