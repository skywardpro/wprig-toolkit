...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function theme_options_enqueue_scripts(): void
	{
		...
		wp_enqueue_style(
			...
			[],
			filemtime(
				get_template_directory() . '/assets/css/admin/theme-settings.min.css',
			),
		);

		$settings = get_option('wp_rig_theme_settings', '');

		wp_localize_script('wp-rig-theme-settings', 'wpRigThemeSettings', [
	...
	{
		register_rest_route('my-theme/v1', '/settings', [
