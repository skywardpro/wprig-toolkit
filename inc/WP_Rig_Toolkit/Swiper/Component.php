...
class Component implements Component_Interface
{
	...
	{
		add_action('wp_enqueue_scripts', [$this, 'action_activate_swiper'], 200);
	}
	...
	public function action_activate_swiper()
	{
		...
		wp_enqueue_script(
			...
			wp_rig()->get_asset_version(
				get_theme_file_path('/assets/js/vendor/swiper/swiper.min.js'),
			),
			false,
		);
		...
		wp_enqueue_style(
			...
			[],
			wp_rig()->get_asset_version(
				get_theme_file_path('/assets/css/vendor/swiper/swiper.min.css'),
			),
		);
	}
}
