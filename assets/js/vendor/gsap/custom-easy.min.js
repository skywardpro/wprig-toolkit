	...
	function x(e, t, n, s, a, r, i, o, h, u, c) {
		...
		return (
			u ||
				...
				(c = 1)),
			u.splice(c || u.length - 1, 0, { x: b, y: w }),
			h * (P * P + S * S) < (N + D) * (N + D) &&
				((f = u.length),
				x(e, t, l, g, M, v, b, w, h, u, c),
				x(b, w, C, E, p, y, i, o, h, u, c + 1 + (u.length - f))),
			u
		);
	}
	var M,
			...
			(((t = CustomEase.prototype).setData = function setData(e, t) {
				...
				if (((i = 1 / (n = (1 / l + 1) | 0)), (h = g[(o = 0)]), p)) {
					for (r = 0; r < n; r++)
						(c = r * i),
							h.nx < c && (h = g[++o]),
							(s = h.y + ((c - h.x) / h.cx) * h.cy),
							(d[r] = { x: c, cx: i, y: s, cy: 0, nx: 9 }),
							r && (d[r - 1].cy = s - d[r - 1].y);
					(o = g[g.length - 1]),
						(d[n - 1].cy = o.y - s),
						(d[n - 1].cx = o.x - d[d.length - 1].x);
				} else {
					for (r = 0; r < n; r++)
			...
			(CustomEase.getSVGData = function getSVGData(e, t) {
				...
				if (
					...
					for (
						...
						(o = s(d + r * i * g)),
							(h = s(p + e(r * i) * -x)),
							(Math.abs((h - l) / (o - f) - a) > c ||
								r === u - 1) &&
								(n.push(f, l), (a = (h - l) / (o - f))),
							(f = o),
							(l = h);
					n = "M" + n.join(",");
				}
