...
!(function (t, e) {
	...
	function u() {
		return (
			y.pageXOffset || g.scrollLeft || a.scrollLeft || b.scrollLeft || 0
		);
	}
	function v(t) {
		return (
	...
	function B(t, e, i, n, r, a, s) {
		return (
			(t.a = e), (t.b = i), (t.c = n), (t.d = r), (t.e = a), (t.f = s), t
		);
	}
	var g,
		y,
	...
	function ja(e, i, n) {
		...
		return (
			(r = ot(r, e, !0)), (e.x = P(r.x, 0.01)), (e.y = P(r.y, 0.01)), o
		);
	}
	function ka(t, e) {
		return (
	...
	function za(t) {
		if (t !== l) {
			...
			if (t && (i || n)) {
				for (; r--; ) j[r] = e[H[r]];
				i &&
					((e.width = o.clientWidth + "px"),
					(e.overflowY = "hidden")),
					n &&
						((e.height = o.clientHeight + "px"),
						(e.overflowX = "hidden")),
					(l = t);
			} else if (l) {
				for (; r--; )
			...
			(m = function run() {
									...
									: v.isVisible !== g.isVisible &&
									  (v.isVisible
											? g.isVisible ||
											  ...
											  H.splice(l--, 1),
											  S && L && ot(g, v, A, z))
											: (g.isVisible && G.push(g),
											  H.splice(l--, 1))),
							  A ||
									((u.style.maxWidth =
										Math.max(g.width, v.width) + "px"),
									(u.style.maxHeight =
										Math.max(g.height, v.height) + "px"),
									(u.style.minWidth =
										Math.min(g.width, v.width) + "px"),
									(u.style.minHeight =
										Math.min(g.height, v.height) + "px")),
				...
				if (
					...
					Y.stagger = function (t, e) {
						return O(
							~q.indexOf(e) ? c.indexOf(H[t].swap.t) : t,
							e,
							i
						);
					};
				...
				if (
					(it.forEach(function (t) {
						return (
							r[t] && R.eventCallback(t, r[t], r[t + "Params"])
						);
					}),
					C && c.length)
				)
				...
				return (
					e &&
						((function _interrupt(t) {
							t.vars.onInterrupt &&
								t.vars.onInterrupt.apply(
									t,
									t.vars.onInterruptParams || []
								),
					...
					(a = g[n]),
						...
						s
							? ((l =
							  ...
							  mh(
									o.element !== i.element && a ? a : o,
									i,
									i.element
							  ),
							  mh(
									a && a.element === s.element ? a : o,
									s,
									s.element
							  ),
							  a &&
	...
	function FlipState(t, e, i) {
		if (
			((this.props = e && e.props), (this.simple = !(!e || !e.simple)), i)
		)
	...
	var q,
		ht =
			(((q = ElementState.prototype).isDifferent = function isDifferent(
				t
			) {
				var e = this.bounds,
					i = t.bounds;
	...
	var Z,
		J =
			(((Z = FlipAction.prototype).getStateById = function getStateById(
				t
			) {
					...
					tt = this,
						...
						this.actions.forEach(function (t) {
							...
							a &&
								...
								(i = e.compare(pt.getState(a))).enter.length &&
									n &&
									n(i.enter),
