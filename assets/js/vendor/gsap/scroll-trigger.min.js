		...
		if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
			...
			(g = "scroll" + n.d2),
				X(
					...
					(k && 20 < S) ||
						(!k &&
							(u ? Math.max(We[g], Ue[g]) : o.parentNode[g]) <=
								S + 1)
				),
				u &&
					((l = _t(a)),
		...
		Pt = function _setState(e) {
			if (e) {
				var t,
					...
					o = 0;
				for (
					(e.t._gsap || Ne.core.getCache(e.t)).uncache = 1;
					o < i;
					o += 2
				)
					(r = e[o + 1]),
				...
				var n = e.getBoundingClientRect(),
					...
					o =
						null == t
							...
							: parseFloat(t) || 0;
				return r
					? (n.left + o) / Xe.innerWidth
					: (n.top + o) / Xe.innerHeight;
			}),
	...
	function Cc(e) {
		...
		return (
			...
			(e.onPress = function () {
				...
				var e = y;
				(y = Ja(
					((Xe.visualViewport && Xe.visualViewport.scale) || 1) / x
				)),
					a.pause(),
					e !== y && vc(p, 1.01 < y || (!f && "x")),
					(c = m()),
