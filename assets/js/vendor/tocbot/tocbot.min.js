	...
	var e = {
			163: (e) => {
				e.exports = function (e) {
					...
					function s(t) {
						...
						return (
							t &&
								((l += r + e.collapsibleClass), (l += r + e.isCollapsedClass)),
			...
			971: function (e, t, n) {
				...
				((l = []),
					(o = (function (e) {
						...
						if ('undefined' != typeof window || u) {
							...
							return (
								(s.destroy = function () {
									if (!i.skipRendering) {
										var e = document.querySelector(i.tocSelector);
										e && (e.innerHTML = '');
									}
									...
									if (
										...
										(i.skipRendering || t.render(i.tocSelector, h),
											(this._scrollListener = m(function (e) {
												(t.updateToc(l), !i.disableTocScrollSync && d(i));
												var n =
													e &&
													e.target &&
					...
					void 0 === (r = 'function' == typeof o ? o.apply(t, l) : o) ||
						(e.exports = r));
			},
			279: (e) => {
				e.exports = function (e) {
