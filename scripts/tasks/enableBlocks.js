...
const testSourceDir = path.resolve(
	__dirname,
	'../../optional/tests/phpunit/unit/Blocks'
);
 ...
 */
export default function enableBlocks() {
	...
	if (fs.existsSync(themePath)) {
		...
		if (!themeContent.includes('new Blocks\\Component()')) {
			...
			if (themeContent.includes(optionsLine)) {
				...
				console.log('inc/Theme.php updated: Blocks\\Component initialized.');
			} else {
				console.error(
